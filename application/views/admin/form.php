            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                      ...
                      <li  >
                        <a  href="<?php echo site_url('admin/dataartikel'); ?>"><i class="fa fa-table fa-3x"></i> Data artikel</a>
                    </li>
                    <li  >
                        <a class="active-menu"  href="<?php  echo site_url('admin/formartikel'); ?>"><i class="fa fa-edit fa-3x"></i> Artikel baru </a>
                    </li>				
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <form role="form" action="<?php echo site_url('admin/postingartikel'); ?>" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="isi" class="form-control ckeditor"  placeholder="isi artikel"></textarea>
                                        </div>
